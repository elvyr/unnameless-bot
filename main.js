...
//   browser: ['Nameless Browser','Safari','1.0.0']
// }
const connectionOptions = {
	version,
  printQRInTerminal: true,
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.sDesc = '_Description has been changed to_\n_*@desc*_'
  conn.sSubject = '_Subject has been changed to_\n_*@subject*_'
  conn.sIcon = '_Icon has been changed to_'
  conn.sRevoke = '_Group link has been changed to_\n_*@revoke*_'
